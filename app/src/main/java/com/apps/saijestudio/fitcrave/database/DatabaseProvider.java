...
public class DatabaseProvider extends ContentProvider {
    ...
    private static final String TAG =
            DatabaseProvider.class.getSimpleName();

    /**
     * Use AcronymDatabaseHelper to manage database creation and version
     * management.
     */
    private DatabaseDbHelper mOpenHelper;
    ...
    private static final int GROCERIES = 200;
    private static final int RESTAURANTS = 300;
    ...
    private static final int GROCERY = 201;
    private static final int RESTAURANT = 301;
    private static final int VIDEO = 401;
    private static final int USER = 501;
    ...
    private static UriMatcher buildUriMatcher() {
        ...
        matcher.addURI(DatabaseContract.CONTENT_AUTHORITY,
                DatabaseContract.PATH_RECIPE,
                RECIPES);
        matcher.addURI(DatabaseContract.CONTENT_AUTHORITY,
                DatabaseContract.PATH_RECIPE
                        + "/#",
        ...
        matcher.addURI(DatabaseContract.CONTENT_AUTHORITY,
                DatabaseContract.PATH_RESTAURANT,
                RESTAURANTS);
        matcher.addURI(DatabaseContract.CONTENT_AUTHORITY,
                DatabaseContract.PATH_RESTAURANT
                        + "/#",
    ...
    public boolean onCreate() {
        mOpenHelper =
                new DatabaseDbHelper(getContext());
        return true;
    }
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
            case RECIPES:
                return DatabaseContract.RecipeSearch.CONTENT_ITEMS_TYPE;
            case RECIPE:
                return DatabaseContract.RecipeSearch.CONTENT_ITEM_TYPE;

            case GROCERIES:
                return DatabaseContract.GrocerySearch.CONTENT_ITEMS_TYPE;
            case GROCERY:
                return DatabaseContract.GrocerySearch.CONTENT_ITEM_TYPE;

            case RESTAURANTS:
                return DatabaseContract.RestaurantSearch.CONTENT_ITEMS_TYPE;
            case RESTAURANT:
                return DatabaseContract.RestaurantSearch.CONTENT_ITEM_TYPE;

            case VIDEOS:
                return DatabaseContract.VideoSearch.CONTENT_ITEMS_TYPE;
            case VIDEO:
                return DatabaseContract.VideoSearch.CONTENT_ITEM_TYPE;

            case USERS:
                return DatabaseContract.UserInfo.CONTENT_ITEMS_TYPE;
            case USER:
                return DatabaseContract.UserInfo.CONTENT_ITEM_TYPE;
    ...
    public Cursor query(Uri uri,
        ...
        switch (sUriMatcher.match(uri)) {
            case ACRONYMS:
                ...
                // into the method.
                retCursor = db.query(AcronymContract.AcronymEntry.TABLE_NAME, projection, selection, selectionArgs, null, null, sortOrder);
                break;
            case ACRONYM:
                ...
                retCursor = db.query(AcronymContract.AcronymEntry.TABLE_NAME, projection, selection + rowId, selectionArgs, null, null, sortOrder);
                break;
            default:
                throw new UnsupportedOperationException("Unknown uri: "
                        + uri);
